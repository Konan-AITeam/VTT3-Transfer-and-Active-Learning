...
class Generator(nn.Module):
    ...
    def __init__(self, conv_dim=64, c_dim=5, repeat_num=6):
        ...
        layers.append(nn.Conv2d(128, conv_dim, kernel_size=7, stride=1, padding=3, bias=False))
        ...
        layers.append(nn.Conv2d(curr_dim, 128, kernel_size=7, stride=1, padding=3, bias=False))
